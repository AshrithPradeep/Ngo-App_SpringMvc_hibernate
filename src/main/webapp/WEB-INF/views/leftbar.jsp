		...
		<div id="sidebar-menu">
			...
			<ul class="metismenu" id="side-menu">
				<c:if test="${sessionBean.role eq 'Admin'}">
					<li><a href="${pageContext.request.contextPath}/users/list" class="waves-effect"><i
							class="mdi mdi-account-location"></i> <span> Users </span> </a></li>
				</c:if>

				<c:if test="${sessionBean.role eq 'Volunteer'}">
					<li><a href="${pageContext.request.contextPath}/agency/volunteer/list" class="waves-effect"><i
							class="mdi mdi-account-location"></i> <span> NGO List </span> </a></li>
				</c:if>
				<c:if test="${sessionBean.role eq 'Data Entry manager'}">
					<li><a href="${pageContext.request.contextPath}/agency/list" class="waves-effect"><i

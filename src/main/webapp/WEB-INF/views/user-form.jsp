											...
											<div class="col-sm-10">
												<form:select path="role" modelAttribute="user"
													...
													<option value="Data Entry manager"
														<c:if test="${user.role eq 'Data Entry manager'}">selected="true"</c:if>>
														Data Entry manager</option>
													<option value="Application Manager"
														<c:if test="${user.role eq 'Application Manager'}">selected="true"</c:if>>
